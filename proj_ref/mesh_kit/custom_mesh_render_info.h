...
#include <libs\cgv_gl\gl\render_info.h>
...
class CGV_API custom_mesh_render_info : public cgv::render::render_info
{
public:
	/// index triple type
...
public:
	...
	template <typename T>
	void construct(cgv::render::context& ctx, cgv::media::mesh::simple_mesh_ext<T>& mesh)
	{
