...
custom_mesh_render_info::custom_mesh_render_info() :
...
///
void custom_mesh_render_info::destruct(cgv::render::context& ctx)
{
...
///
void custom_mesh_render_info::construct_vbos_base(
...
///
void custom_mesh_render_info::finish_construct_vbos_base(cgv::render::context& ctx,
...
bool custom_mesh_render_info::bind(context& ctx, shader_program& prog, bool force_success, int aa_index)
{
	return render_info::bind(ctx, prog, force_success, 0);
}

/// bind all or specific aa to the passed shader program
bool custom_mesh_render_info::bind_wireframe(context& ctx, shader_program& prog, bool force_success)
{
...
void custom_mesh_render_info::construct_draw_calls(cgv::render::context& ctx)
{
...
void custom_mesh_render_info::draw_primitive(cgv::render::context& ctx, size_t primitive_index, bool skip_opaque, bool skip_blended, bool use_materials)
{
...
void custom_mesh_render_info::draw_wireframe(cgv::render::context& ctx)
{
